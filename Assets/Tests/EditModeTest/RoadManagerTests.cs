...
namespace Tests
{
    public class RoadManagerTests
    {
        ...
        {
            var result = RoadManager.CheckIfCornerRoadFits((int)Direction.Up | (int)Direction.Right, null, roadSO);
        ...
        {
            var result = RoadManager.CheckIfCornerRoadFits((int)Direction.Down | (int)Direction.Right, null, roadSO);
            Assert.AreEqual(roadCorner, result.RoadPrefab);
            Assert.AreEqual(RotationValue.R90, result.RoadPrefabRotation);
        }
        [Test]
        ...
        {
            var result = RoadManager.CheckIfCornerRoadFits((int)Direction.Down | (int)Direction.Left, null, roadSO);
            Assert.AreEqual(roadCorner, result.RoadPrefab);
        ...
        {
            var result = RoadManager.CheckIfCornerRoadFits((int)Direction.Up | (int)Direction.Left, null, roadSO);
            Assert.AreEqual(roadCorner, result.RoadPrefab);
        ...
        {
            var result = RoadManager.CheckIf3WayRoadFits((int)Direction.Up | (int)Direction.Right | (int)Direction.Down, null, roadSO);
        ...
        {
            var result = RoadManager.CheckIf3WayRoadFits((int)Direction.Right | (int)Direction.Down | (int)Direction.Left, null, roadSO);
            Assert.AreEqual(road3Way, result.RoadPrefab);
            Assert.AreEqual(RotationValue.R90, result.RoadPrefabRotation);
        }
        [Test]
        ...
        {
            var result = RoadManager.CheckIf3WayRoadFits((int)Direction.Down | (int)Direction.Left | (int)Direction.Up, null, roadSO);
            Assert.AreEqual(road3Way, result.RoadPrefab);
            Assert.AreEqual(RotationValue.R180, result.RoadPrefabRotation);
        }
        [Test]
        ...
        {
            var result = RoadManager.CheckIf3WayRoadFits((int)Direction.Up | (int)Direction.Left | (int)Direction.Right, null, roadSO);
            Assert.AreEqual(road3Way, result.RoadPrefab);
            Assert.AreEqual(RotationValue.R270, result.RoadPrefabRotation);
        }
        [Test]
        ...
        {
            var result = RoadManager.CheckIf4WayRoadFits((int)Direction.Up | (int)Direction.Left | (int)Direction.Right | (int)Direction.Down, null, roadSO);
