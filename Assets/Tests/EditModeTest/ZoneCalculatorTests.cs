...
namespace Tests
{
    public class ZoneCalculatorTests
    {
        ...
        [Test]
        public void ZoneCalculatorTestCalculateZoneSmallerThanPreviousPlacement()
        {
            HashSet<Vector3Int> newPositionsList = new HashSet<Vector3Int>();
            Dictionary<Vector3Int, GameObject> structuresToBeModified = new Dictionary<Vector3Int, GameObject>();
            GameObject structure = new GameObject();
        ...
        [Test]
        public void ZoneCalculatorTestPrepareStartAndEndPositionBottomLeft2TopRight()
        {
        ...
        [Test]
        public void ZoneCalculatorTestPrepareStartAndEndPositionTopRight2BottomLeft()
        {
        ...
        [Test]
        public void ZoneCalculatorTestPrepareStartAndEndPositionTopLeft2BottomRight()
        {
        ...
        [Test]
        public void ZoneCalculatorTestPrepareStartAndEndPositionBottomRight2TopLeft()
        {
